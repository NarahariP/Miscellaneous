...
public class MaxDateTest {
	...
	public static void main(String[] args) {
		...
		Date today=calendar0.getTime();
		
		Calendar  calendar1 =Calendar.getInstance();
		calendar1.add(Calendar.YEAR, 9);
		Date fdate=calendar1.getTime(); 
		
		Calendar  calendar2 =Calendar.getInstance();
		calendar2.add(Calendar.YEAR, -2);
		Date ol=calendar2.getTime();
		
		
		
		if(fdate.after(today))
		...
		System.out.println("Feture Date: "+fdate);
		System.out.println("Old Date: "+ol);
